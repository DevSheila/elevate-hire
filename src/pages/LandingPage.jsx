        ...
        <div className="relative py-12 sm:py-16 lg:py-20 lg:pb-36">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto grid max-w-lg grid-cols-1 gap-y-12 lg:max-w-full lg:grid-cols-2 lg:items-center lg:gap-x-8">
              <div>
                <div className="text-center lg:text-left">
                  ...
                  <div className="mt-8 flex flex-col items-center justify-center sm:flex-row sm:space-x-4 lg:justify-start">
                    <button className="relative mt-4 rounded-full border-2 border-blue-600 bg-blue-600 px-6 py-2 font-medium text-white transition hover:translate-y-1">
                    ...
                    <button className="mt-4 flex items-center rounded-full border-2 border-blue-600 px-6 py-2 font-medium text-blue-600 transition hover:translate-y-1 hover:bg-white">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="relative bg-violet-100 bg-transparent">
                <img
                  className="relative"
                  src="/hero.png"
                  frameborder="0"
